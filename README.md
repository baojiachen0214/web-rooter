<div align="center">
  ...
  <p>
    ...
    <img src="https://img.shields.io/badge/version-v0.2.3-blue.svg" alt="Version v0.2.3">
...
Release 页面：  
[https://github.com/baojiachen0214/web-rooter/releases/tag/v0.2.3](https://github.com/baojiachen0214/web-rooter/releases/tag/v0.2.3)
...
这一版优先解决“会让 AI 生产流崩掉”的问题：

- `aiohttp` 的 SSL 证书链不再只依赖系统环境，统一改为显式 CA bundle 优先、系统证书链兜底
